...
const STATUS_COLORS = {
  ...
  ABANDONED: 'bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400 border border-red-300 dark:border-red-700',
...
export const StatusBadge = ({ status, className = '' }) => {
  return (
    <span
      className={`inline-block px-3 py-1 rounded-lg text-xs font-semibold ${STATUS_COLORS[status] || STATUS_COLORS.BACKLOG
        } ${className}`}
    >
